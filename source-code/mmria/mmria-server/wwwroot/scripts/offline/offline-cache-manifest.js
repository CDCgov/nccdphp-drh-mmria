(function(root) {
    ...
    const requiredStaticExpectations = [
        ...
        { path: '/scripts/case/edit-inactivity-manager.js', validation: 'javascript_non_empty', expectedStatus: 200, expectedContentType: 'javascript', blockOnFailure: true },
    ...
    const additionalRequiredStaticFiles = [
            ...
            '/scripts/case/edit-inactivity-manager.js',
