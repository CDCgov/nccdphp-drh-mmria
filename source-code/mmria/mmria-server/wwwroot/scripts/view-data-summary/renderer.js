    ...
    return `
            ...
            <div class="vertical-control">
                ...
                <div class="d-flex pl-0">
                    ...
                    <div class="form-check">
                        <input class="mr-2" type="radio" onchange="date_of_review_panel_select(this.value)" name="select_date_of_review_panel" id="select_review_dates_radio"  value="select"  ${!g_filter.include_blank_date_of_reviews ? 'checked="true"' : '' }/>
            ...
            <div class="no-print d-flex ml-3">
                ...
                <div class="d-flex ml-auto">
                    <div class="d-flex flex-wrap align-items-center pl-0 col-sm-12 button-container">
                        ...
                        <span class="spinner-container spinner-inline ml-2"><span class="spinner-body text-primary"><span class="spinner"></span><span class="sr-only">Loading...</span></span></span>          
                    </div>
                </div>
            </div>
        </div>
