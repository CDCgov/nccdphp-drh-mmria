            ...
            <div class="d-flex flex-column">
                <div class="d-flex mr-1">
                    <div class="col-md-7 pr-3">
                        <div>
                            ${await render61_chart(p_post_html, metadata, data_list)}
                        </div>
                        <div class="mt-4">
                            ${await render61_table(metadata, data_list)}
                        </div>
                    </div>
                    <div class="col-md-5">
                        <div>
                            ${await render62_chart(p_post_html, metadata2, data_list2)}
                        </div>
                        <div class="d-flex flex-column mt-4">
                            ${await render62_table(metadata2, data_list2)}
                        </div>
                    </div>
                </div>
...
async function render62_table(p_metadata, p_data_list) {
    ...
    return `
        ...
        <div style="border-color: #d5d5d5 !important; margin-top: 3.4rem !important;" class="d-flex border rounded border-light text-left p-2 mt-3 mb-4 col-md-12">
            <span class="font-weight-bold">Number of deaths with missing (blank) values:</span>
            <span class="ml-auto">${totals.get(p_metadata.blank_field_id)}</span>
        </div>
    `;
