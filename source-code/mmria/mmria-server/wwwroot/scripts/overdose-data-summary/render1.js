...
async function render1_chart(p_post_html, p_metadata, p_data_list)
{
    ...
    render_chart_post_html(425, p_post_html, p_metadata, data, categories, totals);

    return render_chart_card_container(proper_casing(p_metadata.chart_title.toUpperCase()));
}
