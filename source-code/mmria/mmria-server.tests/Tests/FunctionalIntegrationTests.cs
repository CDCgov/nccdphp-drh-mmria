...
public class FunctionalIntegrationTests
{
    ...
    public async Task OneTimeSetUpAsync()
    {
        ...
        _dbHelper = new DatabaseTestHelper(purposeName: "functional_integration");
        ...
        TestContext.WriteLine($"Functional Integration Tests initialized. Database: {_dbHelper.GetTestDatabaseName()}");
    }
    ...
    public async Task OneTimeTearDownAsync()
    {
        ...
        if (_dbHelper != null)
        {
            ...
            TestContext.WriteLine($"Functional Integration Tests cleanup complete.");
        }
    }
