...
using mmria_case_generator.Generators.ValueGenerators;
...
namespace mmria_case_generator.Generators
{
    public class CaseDataGenerator
    {
        ...
        public CaseDataGenerator(MetadataManager metadataManager, GenerationConfig config)
        {
            ...
            _boolGenerator = new BooleanValueGenerator(_faker, config.Strategy, _random);
        ...
        private void PostProcessAutopsyForm(Dictionary<string, object?> caseData)
        {
            ...
            if (caseData["autopsy_report"] is Dictionary<string, object?> autopsyReport)
            {
                ...
                autopsyReport["autopsy_performed"] = _config.Strategy.CompletenessPercentage >= 70 || _random.NextDouble() < 0.8;
        ...
        private void PostProcessPrenatalRecordsForm(Dictionary<string, object?> caseData)
        {
            ...
            var prenatalForm = new Dictionary<string, object?>
            {
                ...
                // Populate substance grid if evidence = "Yes"
                ["substance_use_grid"] = substanceUseEvidence == "Yes" ? _substanceGridGenerator.GeneratePrenatalSubstanceGrid() : null
            };
        ...
        private void PostProcessSocialEnvironmentalProfileForm(Dictionary<string, object?> caseData)
        {
            ...
            var socialForm = new Dictionary<string, object?>
            {
                ...
                ["substance_type"] = (substanceUseHistory == "Yes") ? _faker.PickRandom(new[] { "Alcohol", "Drugs", "Both" }) : null,
                ...
                // Populate substance grid if history = "Yes"
                ["if_yes_specify_substances"] = substanceUseHistory == "Yes" ? _substanceGridGenerator.GenerateSocialSubstanceGrid() : null
            };
