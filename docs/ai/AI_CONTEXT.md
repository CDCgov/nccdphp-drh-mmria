...
| QA field guides for generated MOR/NAT/FET IJE fixture files | [IJE Case Field Guide Generation](./ije_case_field_guides.md) | Use when creating per-case text guides from IJE files under `docs/ai/local/`. |
